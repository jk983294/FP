...
public:
    ...
    EIGEN_STRONG_INLINE I operator[](isize idx) const { return idx; }

    EIGEN_STRONG_INLINE I operator()(isize idx) const { return idx; }

    EIGEN_STRONG_INLINE I inv(isize idx) const { return I(idx); }
...
public:
    ...
    EIGEN_STRONG_INLINE I operator[](isize idx) const { return P[idx]; }

    EIGEN_STRONG_INLINE I operator()(isize idx) const { return P[idx]; }

    EIGEN_STRONG_INLINE I inv(isize idx) const { return P_inv[idx]; }
